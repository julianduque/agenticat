...
import { MessageSquare, Server, AlertCircle, Loader2, XCircle, Copy, Check, RotateCcw } from "lucide-react";
          ...
          {messages.length === 0 ? (
            ...
            {messages.map((message) => (
              <Message 
                ...
                className={cn(
                  "group relative",
                  message.role === "user" && "w-fit max-w-[95%]"
                )}
              >
                <div className="flex flex-col gap-2">
                  ...
                  <div className={cn(
                    ...
                    <MessageStatusIndicator status={message.status} taskState={message.taskState} />
